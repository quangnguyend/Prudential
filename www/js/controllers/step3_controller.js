function step3Ctrl ($scope, $rootScope, $http, $ionicLoading, $stateParams, UserService, SubmissionService, FileService, CommonService) {
    ...
    if ($rootScope.uid > 0) {
        SubmissionService.getStep($scope, 'step3');
    }
